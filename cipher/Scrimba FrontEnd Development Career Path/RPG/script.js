...
class Character {
    ...
    setDiceHtml() {
        // dice.classList.contains('placeholderDice')
...
function fadeInDice(dice) {
    dice.style.opacity = '0'
    setTimeout(dice.style.opacity = '1', 500)
}
...
function endGame(){
    disableAttackBtn()
    // determine who lost
    const endMessage = antagonist.health === 0 ? 'Elephant trumpets in victory' : elephant.health === 0 ? 'The animals triumph' : 'Everyone perished'
    ...
    setTimeout( () => {
        document.body.innerHTML = 
            `<div class="center">
                <div class="endGame border-radius">
